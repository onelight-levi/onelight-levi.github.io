...
function RandomizerForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4">
      ...
      <div className="flex gap-2">
        <input type="range" min={15} max={28} value={minLevel} onChange={e => setMinLevel(+e.target.value)} />
        <input type="range" min={15} max={28} value={maxLevel} onChange={e => setMaxLevel(+e.target.value)} />
      </div>
